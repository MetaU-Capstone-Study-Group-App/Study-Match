...
const SignupForm = () => {
    ...
    const addWeight = (weightValue, weightType) => {
        setFormData((prevState) => ({
            ...prevState,
            ...
            <form className="signup-form" onSubmit={handleSubmit}>
                ...
                <div className="signup-form-second-section"><h4>Compatibility Score Weights</h4>
                    ...
                    <div className="signup-weight-inputs">
                        <label>Personality
                            <WeightsSlider addWeight={addWeight} weightType={"personality_weight"}/>
                        </label>
                        <label>Location
                            <WeightsSlider addWeight={addWeight} weightType={"location_weight"}/>
                        </label>
                        <label>Goals
                            <WeightsSlider addWeight={addWeight} weightType={"goals_weight"}/>
                        </label>
                        <label>School
                            <WeightsSlider addWeight={addWeight} weightType={"school_weight"}/>
                        </label>
                        <label>Class Standing
                            <WeightsSlider addWeight={addWeight} weightType={"class_standing_weight"}/>
                        </label>
                    </div>
                </div>
